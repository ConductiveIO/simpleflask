...
def get_appointments(doctor_id):
    ...
    return jsonify({"appointments": [appointment.as_dict for appointment in appointments]}), 202

def does_time_conflict_exist(doctorId, requestStartTime, requestEndTime):
    # https://nedbatchelder.com/blog/201310/range_overlap_in_two_compares.html
    return Appointment.query.filter_by(doctorId=doctorId).filter(
